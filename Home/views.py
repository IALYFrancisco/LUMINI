    ...
    if request.method == 'POST':
        ...
        if _form.is_valid():
            ...
            if _form.cleaned_data['message_object'] == 'date':
                email_object = 'Prise de rendez-vous 📅'
            
            if _form.cleaned_data['message_object'] == 'simple':
                email_object = 'Simple prise de contact 🤝'
            ...
            payload = {
                ...
                "htmlContent": f"<!DOCTYPE html><html lang=\"en\"><head><meta charset=\"UTF-8\"><meta name=\"viewport\" content=\"width=device-width, initial-scale=1.0\"><title>Document</title></head><body><main style=\"width: 100%;\"><section style=\"background-color: #073B4C; color: white; width: 100%; max-width: 600px; padding: 25px; margin: 100px auto; border-radius: 5px;\"><a href=\"https://lumini.onrender.com\" style=\"color: white;\"><h1 style=\"font-family: 'Trebuchet MS', Arial, sans-serif; display: flex; align-items: center;\"><img src=\"https://lumini.onrender.com/static/img/logo-de-lumini (1).png\" alt=\"Logo de LUMINI\" title=\"Logo de LUMINI\" style=\"width: 40px; margin-right: 5px;\">LUMINI</h1></a><h2 style=\"font-family: 'Trebuchet MS', Arial, sans-serif; margin-top: 50px;\">Bonjour IALY Francisco Raymond 😀,</h2><p style=\"margin-top: 20px; font-family: 'Trebuchet MS', Arial, sans-serif;\">{_form.cleaned_data['client_name']} vous a laissé un message sur LUMINI</p><a href=\"https://lumini.onrender.com\"><button  style=\"margin-top: 50px;color: #073B4C;font-size: 14px;font-weight: 500;background-color: white;border-style: solid;border-width: 2px;border-radius: 3px;border-color: #ffffff;cursor: pointer;padding: 8px 10px;\">aller sur LUMINI</button></a></section></main></body></html>"
            }
